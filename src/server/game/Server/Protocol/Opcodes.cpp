...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_TOGGLE_PVP,                         0x16BA, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTogglePvP                    );
    ...
    DEFINE_OPCODE_HANDLER(MSG_SET_DUNGEON_DIFFICULTY,              0x1898, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetDungeonDifficultyOpcode   );
    DEFINE_OPCODE_HANDLER(MSG_SET_RAID_DIFFICULTY,                 0x16A6, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetRaidDifficultyOpcode      );
	...
	DEFINE_OPCODE_HANDLER(CMSG_SET_RAID_DIFFICULTY,                0x0274, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCmsgSetRaidDifficultyOpcode  );
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TAXINODE_STATUS,                    0x0E23, STATUS_NEVER    );
